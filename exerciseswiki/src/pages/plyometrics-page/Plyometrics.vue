<template>
  <div class="container mt-5">
    <h1>Plyometrics</h1>
    <h5 class="label-spacing1">Plyometrics involve explosive and rapid movements, aiming to improve muscular power, agility, and overall athleticism through dynamic exercises like jumps and hops.
    </h5>
...
export default {
  methods: {
    search() {
      ...
      var apiUrl = 'https://api.api-ninjas.com/v1/exercises?muscle=' + searchInput + '&difficulty=' + selectedDifficulty + '&type=plyometrics'
