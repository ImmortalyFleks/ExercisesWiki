<template>
  <div class="container mt-5">
    <h1>Strength</h1>
    <h5 class="label-spacing1">Strength exercises play a crucial role in building and toning muscles, promoting functional movement, and supporting overall metabolic health.</h5>
...
export default {
  methods: {
    search() {
      ...
      var apiUrl = 'https://api.api-ninjas.com/v1/exercises?muscle=' + searchInput + '&difficulty=' + selectedDifficulty + '&type=strength'
