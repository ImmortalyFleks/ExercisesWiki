<template>
  <div class="container mt-5">
    <h1>Powerlifting</h1>
    <h5 class="label-spacing1">Powerlifting is centered around compound movements, such as squats and deadlifts, designed to maximize strength gains, stimulate muscle growth, and enhance overall physical power.</h5>
...
export default {
  methods: {
    search() {
      ...
      var apiUrl = 'https://api.api-ninjas.com/v1/exercises?muscle=' + searchInput + '&difficulty=' + selectedDifficulty + '&type=powerlifting'
