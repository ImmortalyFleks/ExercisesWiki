<template>
  <div class="container mt-5">
    <h1>Stretching</h1>
    <h5 class="label-spacing1">Stretching contributes to increased flexibility, improved joint range of motion, and reduced muscle stiffness, aiding in injury prevention and overall mobility.</h5>
...
export default {
  methods: {
    search() {
      ...
      var apiUrl = 'https://api.api-ninjas.com/v1/exercises?muscle=' + searchInput + '&difficulty=' + selectedDifficulty + '&type=stretching'
