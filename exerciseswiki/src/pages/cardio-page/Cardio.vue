<template>
  <div class="container mt-5">
    <h1>Cardio</h1>
    <h5 class="label-spacing1">Cardio is essential for improving cardiovascular health, enhancing endurance, and burning calories to aid in weight management.</h5>
...
export default {
  methods: {
    search() {
      ...
      var apiUrl = 'https://api.api-ninjas.com/v1/exercises?muscle=' + searchInput + '&difficulty=' + selectedDifficulty + '&type=cardio'
